     ...
     <nav className="container w-full h- flex justify-between h-16 items-center ">
                <div className='z-10 flex'>
                    <ul className="flex space-x-6 pl-3">
                        ...
                        <li>
                            <a href="../Components/ShopDetail" className="hover:text-red-300">Shop Detail</a>
                        </li>
                        <li className="relative group">
                            ...
                            <ul className="absolute left-0 mt-2 bg-white border border-gray-200 shadow-lg rounded-md w-48 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <li>
                                    <a href="/Components/shopping_cart" className="block px-4 py-2 hover:bg-gray-100">Shopping Cart</a>
                                </li>
                                <li>
                                    <a href="/Components/CheckOut" className="block px-4 py-2 hover:bg-gray-100">Checkout</a>
                                </li>
                            </ul>
                        </li>
                        <li>
