        ...
        <footer className="bg-indigo-50">
            <div className="container mx-auto px-10">
                <div className="flex pt-20">
                    ...
                    <div className="w-1/5">
                        <h1 className="mb-6 text-lg font-semibold text-gray-900 dark:text-white"><strong>Quick Links</strong></h1>
                    ...
                    <div className="w-1/5">
                        <h1 className="mb-6 text-lg font-semibold text-gray-900 dark:text-white"><strong>Newsletter</strong></h1>
