...
const Collectioncontent = () => {
    return (
        <div className="flex  w-full m-4 h-72 ">
            <div className="flex justify-between items-center bg-slate-100 w-1/2 mr-4">
                <div >
            ...
            <div className="flex justify-between items-center bg-slate-100 w-1/2 ml-4">
                <div className="ml-12">
